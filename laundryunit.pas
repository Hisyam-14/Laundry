...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure harga_totalClick(Sender: TObject);
...
procedure TForm1.harga_totalClick(Sender: TObject);
begin
...
begin
  ...
  if normal.Checked = true then
    begin
     harga_awal := 15000;
     if berat <= 5 then harga_total.Caption := FloatToStr(harga_awal - (harga_awal * 0.1))
